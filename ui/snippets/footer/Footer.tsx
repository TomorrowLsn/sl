  ...
  const BLOCKSCOUT_LINKS = [
    {
      ...
      iconSize: "18px",
      text: "Twitter",
      url: "https://x.com/slerfchain",
    },
    {
      icon: "discussions" as const,
      iconSize: "20px",
      text: "Telegram",
      url: "https://t.me/slerfchain_ann",
    },
  ];
    ...
    (gridArea?: GridProps["gridArea"]) => {
      return (
        <Box gridArea={gridArea}>
          <Link fontSize="xs" href="https://slerfchain.xyz">
            Slerfchain.xyz
          </Link>
          <Text mt={3} fontSize="xs">
            Slerfchain is a layer2 block chain driven by memecoin community and
            open source.
          </Text>
